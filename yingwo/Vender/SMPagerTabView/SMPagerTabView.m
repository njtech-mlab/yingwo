...
- (UIView *)selectedLine {
    if (!_selectedLine) {
     //   self.selectedLine = [[UIView alloc] initWithFrame:CGRectMake(0, self.tabView.height - 2, self.selectedLineWidth, 2)];
        self.selectedLine = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.selectedLineWidth, 2)];
